  ...
  <div class="main">
     <div class="wrap">
		<div class="cont span_1_of_2">
			<div class="cont span_2_of_3">
				<div class="image">
					<img src="images/thongbao3.png" alt=""/>
				</div>
			</div>
		</div>
		<div class="desc1 span_1_of_2">
			<h3 class="m_3">THẺ KỲ</h3>
			<p class="m_5">130.000 VND <a href="#">Còn hàng</a></p>
		         	 <div class="btn_form">
						<form>
							<input type="submit" value="Mua ngay " title="">
						</form>
					 </div>
					<span class="m_link"><a href="login.php">Đăng nhập để mua hàng</a> </span>
	    ...
	    <h3 class="m_3">Sản phẩm khác</h3>
		 <ul id="flexiselDemo3">
		<li><img src="images/vethang5.png" /><a href="#">Vé tháng</a><p>20.000</p></li> <!-- Nhi sẽ bỏ ảnh vé tháng 6, để Nhi edit thử-->
			<li><img src="images/theky2.png" /><a href="#">Thẻ Kỳ II</a><p>130.000</p></li> <!-- Nhi sẽ bỏ ảnh vé kỳ , để Nhi edit thử-->
		 </ul>
	...
	<script type="text/javascript" src="js/jquery.flexisel.js"></script>
     ...
     <div class="toogle">
     	...
     	<p class="m_text"> Mỗi thẻ chỉ dành cho 1 phương tiện đã đăng kí trước. Sinh viên không chia sẻ vé thẻ xe cho người khác .</p>
     </div>
      </div>
			</div>
			 <div class="clear"></div>
